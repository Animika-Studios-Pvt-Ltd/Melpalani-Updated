...
!function(t, e) {
    ...
    f = function() {
        ...
        e._removeElement = function(t) {
            ...
            I.supportsTransitionEnd() && o(t).hasClass("fade") ? o(t).one(I.TRANSITION_END, (function(n) {
    ...
    o.fn[a] = f._jQueryInterface,
    o.fn[a].Constructor = f,
    ...
    b = function() {
        ...
        return e.toggle = function() {
            ...
            if (n) {
                ...
                if (i) {
                    if ("radio" === i.type)
                        if (i.checked && d(this._element).hasClass(E))
                            t = !1;
                        else {
            ...
            e && this._element.setAttribute("aria-pressed", !d(this._element).hasClass(E)),
            t && d(this._element).toggleClass(E)
        }
        ,
        e.dispose = function() {
            d.removeData(this._element, _),
            this._element = null
        }
        ,
        t._jQueryInterface = function(e) {
    ...
    d(document).on(T.CLICK_DATA_API, y, (function(t) {
        ...
        b._jQueryInterface.call(d(e), "toggle")
    }
    ...
    d.fn[g] = b._jQueryInterface,
    d.fn[g].Constructor = b,
    ...
    b), D = function(t) {
        var e = "carousel"
          ...
          , y = function() {
            function o(e, n) {
                ...
                this._element = t(e)[0],
                this._indicatorsElement = t(this._element).find(p)[0],
            ...
            v.pause = function(e) {
                e || (this._isPaused = !0),
                t(this._element).find(m)[0] && I.supportsTransitionEnd() && (I.triggerTransitionEnd(this._element),
                this.cycle(!0)),
            ...
            v.to = function(e) {
                ...
                if (!(e > this._items.length - 1 || e < 0))
                    if (this._isSliding)
                        t(this._element).one(u.SLID, (function() {
                            return n.to(e)
                        }
                        ));
                    else {
            ...
            v._slide = function(e, n) {
                var i, s, r, o = this, a = t(this._element).find(g)[0], l = this._getItemIndex(a), c = n || a && this._getItemByDirection(e, a), d = this._getItemIndex(c), _ = Boolean(this._interval);
                if (e === h ? (i = "carousel-item-left",
                ...
                c && t(c).hasClass(f))
                    ...
                    I.supportsTransitionEnd() && t(this._element).hasClass("slide") ? (t(c).addClass(s),
                    I.reflow(c),
                    t(a).addClass(i),
                    t(c).addClass(i),
                    t(a).one(I.TRANSITION_END, (function() {
                        t(c).removeClass(i + " " + s).addClass(f),
                        t(a).removeClass(f + " " + s + " " + i),
                        o._isSliding = !1,
                        setTimeout((function() {
                    ...
                    )).emulateTransitionEnd(600)) : (t(a).removeClass(f),
                    t(c).addClass(f),
                    this._isSliding = !1,
        ...
        return t(document).on(u.CLICK_DATA_API, v, y._dataApiClickHandler),
        ...
        var e = "collapse"
          ...
          , p = function() {
            function i(e, n) {
                ...
                for (var i = t(m), s = 0; s < i.length; s++) {
                    var r = i[s]
            ...
            o.show = function() {
                var e, s, r = this;
                if (!(this._isTransitioning || t(this._element).hasClass(c) || (this._parent && 0 === (e = t.makeArray(t(this._parent).find(_).filter('[data-parent="' + this._config.parent + '"]'))).length && (e = null),
                e && (s = t(e).not(this._selector).data(n)) && s._isTransitioning))) {
                    ...
                    !o.isDefaultPrevented()) {
                        ...
                        if (I.supportsTransitionEnd()) {
                            ...
                            t(this._element).one(I.TRANSITION_END, l).emulateTransitionEnd(600),
            ...
            o.hide = function() {
                ...
                if (!this._isTransitioning && t(this._element).hasClass(c)) {
                    ...
                    !n.isDefaultPrevented()) {
                        ...
                        I.supportsTransitionEnd() ? t(this._element).one(I.TRANSITION_END, a).emulateTransitionEnd(600) : a()
                    }
                }
            }
            ,
            ...
            o._getParent = function() {
                var e = this
                  , n = null;
                I.isElement(this._config.parent) ? (n = this._config.parent,
        ...
        return t(document).on(h.CLICK_DATA_API, m, (function(e) {
        ...
        var e = "dropdown"
          ...
          , E = function() {
                    ...
                    !i) {
                        ...
                        !r.isDefaultPrevented()) {
                            if (!this._inNavbar) {
                                ...
                                var o = this._element;
                                t(e).hasClass(d) && (t(this._menu).hasClass("dropdown-menu-left") || t(this._menu).hasClass(g)) && (o = e),
            ...
            l._getConfig = function(n) {
                ...
                I.typeCheckConfig(e, n, this.constructor.DefaultType),
                n
            }
            ,
            ...
            l._getPlacement = function() {
                var e = t(this._element).parent()
                  , n = "bottom-start";
                return e.hasClass(d) ? (n = "top-start",
                t(this._menu).hasClass(g) && (n = "top-end")) : e.hasClass("dropright") ? n = "right-start" : e.hasClass("dropleft") ? n = "left-start" : t(this._menu).hasClass(g) && (n = "bottom-end"),
                n
            }
            ,
            ...
            a._dataApiKeydownHandler = function(e) {
                if ((/input|textarea/i.test(e.target.tagName) ? !(32 === e.which || 27 !== e.which && (40 !== e.which && 38 !== e.which || t(e.target).closest(m).length)) : h.test(e.which)) && (e.preventDefault(),
                e.stopPropagation(),
          ...
          , v = function() {
            ...
            d.show = function(e) {
                ...
                if (!this._isTransitioning && !this._isShown) {
                    ...
                    t(this._element).on(l.CLICK_DISMISS, g, (function(t) {
                        return n.hide(t)
                    }
                    )),
            ...
            d.hide = function(e) {
                ...
                !this._isTransitioning && this._isShown) {
                    ...
                    this._isShown && !i.isDefaultPrevented()) {
                        ...
                        s ? t(this._element).one(I.TRANSITION_END, (function(t) {
        ...
        return t(document).on(l.CLICK_DATA_API, d, (function(n) {
            var i, s = this, o = I.getSelectorFromElement(this);
            o && (i = t(o)[0]);
        ...
        var e = "tooltip"
          ...
          , E = function() {
            ...
            E.hide = function(e) {
                ...
                s.isDefaultPrevented() || (t(i).removeClass(m),
                "ontouchstart"in document.documentElement && t("body").children().off("mouseover", null, t.noop),
                this._activeTrigger.click = !1,
                this._activeTrigger[v] = !1,
                this._activeTrigger[p] = !1,
                I.supportsTransitionEnd() && t(this.tip).hasClass(_) ? t(i).one(I.TRANSITION_END, r).emulateTransitionEnd(150) : r(),
                this._hoverState = "")
            }
            ,
            E.update = function() {
            ...
            E._enter = function(e, n) {
                ...
                e && (n._activeTrigger["focusin" === e.type ? v : p] = !0),
                t(n.getTipElement()).hasClass(m) || n._hoverState === f ? n._hoverState = f : (clearTimeout(n._timeout),
                n._hoverState = f,
            ...
            E._leave = function(e, n) {
                ...
                (n = n || t(e.currentTarget).data(i)) || (n = new this.constructor(e.currentTarget,this._getDelegateConfig()),
                t(e.currentTarget).data(i, n)),
                e && (n._activeTrigger["focusout" === e.type ? v : p] = !1),
            ...
            E._fixTransition = function() {
                ...
                null === e.getAttribute("x-placement") && (t(e).removeClass(_),
        ...
        var e = "popover"
          ...
          , u = function(r) {
            ...
            u = r,
            (o = f).prototype = Object.create(u.prototype),
            ...
            f._jQueryInterface = function(e) {
                return this.each((function() {
                    ...
                    if ((i || !/destroy|hide/.test(e)) && (i || (i = new f(this,s),
                    t(this).data(n, i)),
                    "string" == typeof e)) {
                        if (void 0 === i[e])
                            throw new TypeError('No method named "' + e + '"');
        ...
        var e = "scrollspy"
          ...
          , C = function() {
            ...
            u._getConfig = function(n) {
                ...
                return I.typeCheckConfig(e, n, l),
                n
            }
            ,
            ...
            u._activate = function(e) {
                ...
                var i = t(n.join(","));
                i.hasClass("dropdown-item") ? (i.closest(p).find(E).addClass(c),
                i.addClass(c)) : (i.addClass(c),
                i.parents(d).prev(g + ", " + m).addClass(c),
                i.parents(d).prev(_).children(g).addClass(c)),
          ...
          , c = function() {
            ...
            return i.show = function() {
                ...
                if (!(this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && t(this._element).hasClass(o) || t(this._element).hasClass("disabled"))) {
                    var n, i, s = t(this._element).closest(".nav, .list-group")[0], a = I.getSelectorFromElement(this._element);
                    if (s) {
        ...
        return t(document).on(r.CLICK_DATA_API, '[data-toggle="tab"], [data-toggle="pill"], [data-toggle="list"]', (function(e) {
            e.preventDefault(),
            c._jQueryInterface.call(t(this), "show")
        }
        )),
        t.fn.tab = c._jQueryInterface,
        t.fn.tab.Constructor = c,
